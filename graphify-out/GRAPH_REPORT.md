...
## Corpus Check
- 171 files · ~282,200 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1039 nodes · 2602 edges · 78 communities (45 shown, 33 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 25 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `92ea75f8`
...
Cohesion: 0.19
Nodes (11): AdminDashboard(), AdminDashboardProps, getInitials(), Tab, ReviewsAdminList(), ReviewsAdminListProps, parseUserAgent(), getInitials() (+3 more)

### Community 1 - "Admin Accounts & Permissions"
Cohesion: 0.07
Nodes (53): AccountsAdminPanelProps, PERMISSION_LABELS, AdminPage(), DELETE(), GET(), PATCH(), POST(), requireMainAccount() (+45 more)
...
Cohesion: 0.11
Nodes (23): metadata, calcStats(), formatDate(), RecenzePage(), Review, ReviewCard(), Window, calcAvg() (+15 more)

### Community 6 - "Address Autocomplete Form"
Cohesion: 0.15
Nodes (15): CategoryProductRows(), Footer(), socialLinks, HomeLink(), anyInStock(), KategorieClient(), maxStock(), TILE_STYLE (+7 more)
...
Cohesion: 0.10
Nodes (26): metadata, metadata, InfoGrid(), LegalLayout(), Section(), PrivacyPage(), TermsPage(), PRIVACY_BODY (+18 more)
...
Cohesion: 0.26
Nodes (13): POST(), requireAccess(), DELETE(), GET(), PATCH(), requireAccess(), sendMessageReplyEmail(), deleteMessage() (+5 more)

### Community 13 - "Category Listing & Featured Products"
Cohesion: 0.17
Nodes (23): CheckoutItem, POST(), GET(), fail(), NewsletterErrorCode, POST(), OrderReqItem, POST() (+15 more)
...
Cohesion: 0.12
Nodes (28): DiscountsAdminPanel(), DiscountsAdminPanelProps, isExpired(), DELETE(), GET(), POST(), requirePermission(), CartContext (+20 more)

### Community 16 - "AdminDashboard.tsx"
Cohesion: 0.17
Nodes (9): ApiOrderItem, CopyButton(), DeliveryAddressBlock(), Dobirka(), KartaStripe(), Snapshot, SnapshotInfo, SnapshotItem (+1 more)
...
Cohesion: 0.22
Nodes (17): GET(), bundles, expandBundle(), getBundleStock(), getRedis(), expandBundlesForStock(), fetchFromRedis(), getStock() (+9 more)

### Community 19 - "Core NPM Dependencies"
Cohesion: 0.14
Nodes (44): BankovniPrevod(), approxConvert(), addressBlock(), bankTransferBlock(), campaignBodyToHtml(), claimDetailsTable(), currencyOf(), esc() (+36 more)
...
Cohesion: 0.29
Nodes (12): fail(), POST(), StockNotifyErrorCode, sendBackInStockEmail(), addWatcher(), fieldKey(), getWatchersForFields(), isValidWatchEmail() (+4 more)

### Community 22 - "Product Search Bar"
Cohesion: 0.08
Nodes (27): CookiesPage(), KontaktPage(), ONasPage(), BlogPreviewList(), PreviewPost, CategoryGrid(), ChatWidget(), CheckoutStepper() (+19 more)
...
Cohesion: 0.08
Nodes (35): geistMono, geistSans, metadata, viewport, CookieBanner(), subscribeConsent(), WelcomeDiscountPopup(), BROWSER_HELP (+27 more)

### Community 29 - "getCurrentSession"
Cohesion: 0.31
Nodes (8): fail(), MessagesErrorCode, POST(), Newsletter(), sendNewMessageAdminEmail(), isValidEmail(), addMessage(), checkAndSetCooldown()
...
Cohesion: 0.18
Nodes (26): InformacePage(), BESTSELLER_SLUGS, KosikPage(), ProductCard(), ObjednavkaPage(), SuccessContent(), DiscountWidget(), Header() (+18 more)

### Community 44 - "priceOverrides.ts"
Cohesion: 0.16
Nodes (15): GET(), generateMetadata(), KategoriePage(), Home(), generateMetadata(), metaDescription(), ProduktPage(), SITE_URL (+7 more)

### Community 46 - "productDiscounts.ts"
Cohesion: 0.39
Nodes (8): normalizePrice(), percentFromSale(), priceEquals(), ProductsAdminList(), ProductsAdminListProps, saleFromPercent(), getProductBySlug(), isBundle()

### Community 47 - "ProductsAdminList.tsx"
Cohesion: 0.39
Nodes (8): fail(), GET(), POST(), ReviewErrorCode, sendReviewThankYouEmail(), addReview(), checkAndSetCooldown(), toPublicReview()

### Community 79 - "page.tsx"
Cohesion: 0.10
Nodes (23): buildCategories(), CategorySection(), FaqCategory, FaqPage(), buildDopravyOptions(), buildPlatbyOptions(), MOCK_ZBOXES, PacketaPoint (+15 more)
...
- **Why does `useT()` connect `Product Search Bar` to `Blog / Magazine CMS`, `getClientIp`, `Address Autocomplete Form`, `Root Layout & Consent Tracking`, `Reviews System`, `ReviewsAdminList.tsx`, `page.tsx`, `AdminDashboard.tsx`, `Core NPM Dependencies`, `priceOverrides.ts`, `page.tsx`, `getCurrentSession`, `package.json`?**
